...
const lotes = [
  {
    ...
    badge: 'VISTAS',
    badgeColor: 'bg-inmo-dorado/10 text-inmo-dorado',
  ...
  },
  {
    ...
    destacado: true,
    mensaje: 'Hola, me interesa el Lote 5 ($25M) que es el más popular. ¿Pueden darme más información?'
  },
  {
    id: 'lote-14',
    numero: 14,
...
export default function Home() {
  ...
  const handleLoteClick = (lote: typeof lotes[0]) => {
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-6 text-center lg:text-left text-inmo-verde">
            ...
            <div className="space-y-4">
              {lotes.map((lote) => (
                <button
                  ...
                  className={`w-full bg-white rounded-lg shadow-md p-4 hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] cursor-pointer text-left ${lote.destacado ? 'border-2 border-inmo-dorado ring-2 ring-inmo-dorado/20' : 'border border-gray-200 hover:border-inmo-dorado'
                    }`}
                >
                  <div className="flex gap-4">
                    <div className="relative w-32 h-32 flex-shrink-0 rounded-lg overflow-hidden">
                      ...
                      />
                      {/* Overlay de hover */}
                      <div className="absolute inset-0 bg-inmo-verde/0 hover:bg-inmo-verde/10 transition-colors duration-300 flex items-center justify-center">
                        <span className="text-white font-bold opacity-0 hover:opacity-100 transition-opacity bg-inmo-verde px-3 py-1 rounded-full text-sm">
                          Ver en WhatsApp
                        </span>
                      </div>
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-inmo-verde hover:text-inmo-dorado transition-colors">
